docker-compose -f dotnet/dotnet2.1/docker-compose-linux.yml build
docker-compose -f dotnet/dotnet3.1/docker-compose-linux.yml build

docker push docker.dev.mfire.co/mindfire.dotnet.node:2.1-sdk-alpine
docker push docker.dev.mfire.co/mindfire.dotnet.node:2.1-runtime-alpine
docker push docker.dev.mfire.co/mindfire.dotnet.node:2.1-aspnetcore-alpine
...
docker push mindfiretech/dotnet.node:2.1-sdk-alpine
docker push mindfiretech/dotnet.node:2.1-runtime-alpine
docker push mindfiretech/dotnet.node:2.1-aspnetcore-alpine
